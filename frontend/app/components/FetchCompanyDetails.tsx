          ...
          <div className="flex flex-col bg-neutral-900 p-6 px-10 ml-5 mr-10 rounded-lg gap-4">
            ...
            {tenders.length > 0 ? (
              <div className="grid grid-cols-1  gap-6">
                {tenders.map((tender) => (
                  <div key={tender.id} className=" relative bg-neutral-900 border-2 border-neutral-800 shadow-sm  rounded-md p-4">
                    <div className="text-lg">{tender.title}</div>
                    <div className="text-neutral-400 mb-2 ">{tender.type}</div>
                    <div className="mb-4 text-neutral-400 max-w-4xl ">{tender.description}</div>
